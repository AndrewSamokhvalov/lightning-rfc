...
4. Create link 'node-id-1'<->'bitcoin-key-1'
5. Prove ownership of 'node-id-2'
6. Create link 'node-id-2'<->'bitcoin-key-2'
7. Check link 'bitcoin-key-1'<->'bitcoin-key-2'
...
7. Checking that funding transaction output meets all needed criteria we prove the link between
'bitcoin-key-1'<->'bitcoin-key-2'.
```
